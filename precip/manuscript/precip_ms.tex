...
\begin{enumerate}
\item Climate is thought to be an important driver of population ecology however it can be difficult to determine which aspects of climate affect populations and at which stages in an organisms life-cycle.  Moreover, there have been few tests of whether statistical models fit to observational data on climate and populations can accurately predict the future responses of populations to natural or experimentally imposed climate conditions.   
\item Using observational data collected from the 1920's to the 1950's from a sagebrush steppe plant community, previous research has reported a wide variety of climate effects on four dominant plant species. We tested whether statistical models based on these observational data could predict how these species respond to a experimentally imposed drought and irrigation from 2006 to 2016. 
\\item We established sixteen new plots in the same location as the historical data and assigned each to either drought or irrigation treatments imposed using rainfall shelters and automatic sprinklers. The original plots were also monitored and served as ambient climate controls. In order to describe the demographic effects of the climate manipulations, we used all data, observational and experimental, to fit a set of statistical models describing each species survival, growth and recruitment in response to local competitive interactions and the effects of the climate manipulation experiment. Next we fit another set of models to only the observational data that used temperature and soil moisture as covariates to describe annual variation in the vital rates.  Finally, we used the second set of models fitted only to the observational data, to predict the effects of the experimental treatments on each species vital rates and used the vital rates to parameterize an individual based population model and predict one step ahead cover in each of the experimental plots.   
\item The experimental drought and irrigation treatments successfully lowered and increased soil moisture respectively.  Over the course of the experiment, average plot cover of \textit{Hesperostipa comata} and \textit{Pseudoroegneria spicata} declined, while cover of \textit{Poa secunda} showed a trend towards increase in the irrigated plots. At the level of individual vital rates, experimental drought reduced \textit{Hesperostipa comata} and \textit{Poa secunda} growth and survival. Drought increased and irrigation decreased \textit{Artemisia tripartita} growth. Recruitment rates for all three grasses were lower in both the drought and irrigation plots than in the control plots. 
...
Climate is widely considered one of the most powerful external forces driving changes in species abundance across space and time \citep{teller_linking_2016}.  The effects of climate on populations and ecosystems are most apparent at the largest scales in space and time: climate determines the distribution of ecosystems, treelines and the the range limits of many species \citep{}, while The paleoecological record shows that long-term climate change lead to changes in species abundance and changes in species' ranges \citep{davis}. Nevertheless, for many species it is difficult to determine how annual climate variation affects populations and demographic rates \citep{ehrlen_advancing_2016}. Observational data on species performance across years with varying climate can provide some information on how climate might affect population abundance \citep{dalgleish_climate_2010,ehrlen_advancing_2016}. However, many years of data are needed to reliably detect climate effects, especially when annual variation in demographic rates is high \citep{teller_linking_2016,gerber_optimal_2015}. Understanding the effects of climate on populations is increasingly important, however, if we are to understand and predict the effects of climate change on populations. If models fit to historical data can be used to accurately predict the effects of experimental climate manipulations, it would be strong confirmation that the climate effects they describe are real and will hold in the future \citep{}.  
