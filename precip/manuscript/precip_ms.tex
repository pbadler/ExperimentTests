...
Since we only collected automatic soil moisture and temperature data in half of the 16 experimental plots, we conducted a simple statistical analysis to determine the average effect of the rain-out shelters and irrigation treatments on the observed observed plots and then applied these average effects to all the plots in the experiment. We expected that differences in the soil moisture between drought irrigation plots might become more apparent after and during periods of rainfall we first classified the daily climate during the experimental period into dry and rainy days. Rainy days were defined as any days when average temperatures were above 3 degrees C and precipitation was over x mm. The days after a day classified as rainy were also classified as rainy. We then averaged datalogger readings by day and plot within each plot group (one drought, one irrigation and one ambient plot each). For each plot group, we then subtracted the drought and irrigation readings from the ambient measurements. We then modeled the average deviations in soil moisture and temperature in the experimental treatments as a function of season, raininess and their interaction. We used the parameters from this model to describe the average effects of the experimental treatments on soil moisture in all 16 experimental plots in the study            

We conducted a simple statistical analysis of differences in cover trends on treatment plots. The response variable for this analysis was change in cover at the quadrat scale measured at the start of the experiment in spring 2011 prior to manipulation, to the last year of the experiment in 2016. We calculated this change in cover as $log(Cover_{t+1}/Cover_t)$ per plot. We tested for the effect of precipitation treatment on this change in cover with a linear model in \textit{R}. We considered the precipitation treatment effects to be significant when??.
...
We averaged daily soil moisture predictions from SOILWAT from the 5, 25 and 30 and 40 cm soil layers, and daily mean temperature, and then aggregated these seasonally. 
