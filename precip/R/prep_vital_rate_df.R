...
source(file.path('R','prep_vital_rate_df_functions.R'))

prep_vital_rate_df <- function( clim_file = 'data/temp_data/all_clim_covs.RDS', gfile = 'data/vital_rate/ARTR_growth.csv', sfile = 'data/vital_rate/ARTR_survival.csv', rfile = NULL){ 
