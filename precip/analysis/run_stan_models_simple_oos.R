...
#args <- c('.', 'data/temp_data/short_model_table_oos.csv', 1, 0,  FALSE)
...
temp_fit <- run_stan_model_oos(species, vital_rate, model, do_lambda = lambda, do_prior_sd = sd, year_oos = year_oos, nchains = nchains, niter = niter, predict = predict, pars = use_pars)
