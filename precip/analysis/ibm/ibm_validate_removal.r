...
if(trtEffects==F){
 outfile1=paste("output/ibm/simulations/",qName,"_validation_cov_removals_noTrt.csv",sep="")
 outfile2=paste("output/ibm/simulations/",qName,"_validation_den_removals_noTrt.csv",sep="")
}else{
 outfile1=paste("output/ibm/simulations/",qName,"_validation_cov_removals_Trt.csv",sep="")
 outfile2=paste("output/ibm/simulations/",qName,"_validation_den_removals_Trt.csv",sep="") 
}
...
for(i in 1:length(sppList)){
  infile=paste("~/driversdata/data/idaho_modern/speciesData/",sppList[i],"/",sppList[i],"_genet_xy.csv",sep="")
...
source("analysis/survival/import2ibm_deterministic.r")
