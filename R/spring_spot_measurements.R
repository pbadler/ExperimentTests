...
p2 <- read.csv('data/soil_moist_data/spot_measurements/2015-04-29_spot_measurements.csv', skip = 2)
p3 <- read.csv('data/soil_moist_data/spot_measurements/2015-05-07_spot_measurements.csv') 
p4 <- read.csv('data/soil_moist_data/spot_measurements/2016-05-10_spot_measurements.csv')
p5 <- read.csv('data/soil_moist_data/spot_measurements/2015-06-09_spot_measurements.csv')
