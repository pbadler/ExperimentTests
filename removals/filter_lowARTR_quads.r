...
tmp1 <- read.csv(paste0("../../../driversdata/data/idaho/speciesData/ARTR/quadratCover.csv"))
tmp1$year<-tmp1$year + 1900
# modern ARTR quad cover
tmp2 <- read.csv(paste0("../../../driversdata/data/idaho_modern/speciesData/ARTR/quadratCover.csv"))
covD <- rbind(tmp1,tmp2)

# get list of all quad years
#  load quad inventories
QInv1 <- read.csv(paste0("../../../driversdata/data/idaho/quad_inventory.csv"))
