...
\begin{table}[ht]
\centering
\caption{Summary of fixed effects for the \textit{Poa secunda} survival model (see Table \ref{ARTRsurvival} for an explanation of coefficient names
and column headers).} 
\label{POSEsurvival}
\begin{tabular}{rrrrrrrr}
  \hline
...
\begin{table}[ht]
\centering
\caption{Summary of fixed effects for the \textit{Poa secunda} growth model (see Table \ref{ARTRgrowth} for an explanation of coefficient names
and column headers).} 
\label{POSEgrowth}
\begin{tabular}{rrrrrrrr}
  \hline
