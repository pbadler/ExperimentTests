...
% I could be wrong but I think the left-hand side of the equation needs to be 
% indexed to {t + 1} not t.  
...
% could be cases where predictions still technically differ from observations. For % instance, do predictions technically differ from observations if they predict the % mean, but underestimate the variance? Something to consider.
...
% another hypotheses about PSSP
% I predict you will cut this! :)  
...
% added this nutnet tie-in that I think is cool; it could go up after the Yenni 
% reference above.   
