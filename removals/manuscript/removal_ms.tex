...
A final possibility is that our removal treatment influenced grass growth through some other mechanism, unrelated to competition. Maybe the loss of shrub cover benefits grasses by reducing small mammal herbivory (FIND REF)? Without a better understanding of the mechanism driving increased grass growth in the shrub removal quadrats, we are hesitant to dramatically adjust our prior understanding based on models fit to decades of observational data.  }
...
\subsection*{Lessons for studying competition}
