...
is well-defined; we do not know of valid tests for fitting on one data set and testing on another (GILES??). In addition, the alternative approach would return 
...
determine whether this reflects a poorly estimated competition coefficient, or some other effect of the removal treatment besides competitor densities.}
